...
<body>
    <header>
        <h1 class="titulo">Servicios de <span>Freelancer</span></h1>
    </header>
    ...
    <section class="hero">
        <div class="contenido-hero">
            ...
            <div class="ubicacion">
                <img src="img/mexico.png" alt="mexico" id="mexico">
    ...
    <footer class="footer">
        <p>Todos los derechos reservados. Luis Arturo Freelancer</p>
    </footer>
